...
class JobCollect {
    ...
    public JobCollect(String name, int clientId, int duration, int deadline, String timestamp) {
        this.name = name;
            ...
            try (BufferedReader br = new BufferedReader(new FileReader(file))) {
                ...
                while ((line = br.readLine()) != null) {
                    ...
                    if (!name.isEmpty() && duration > 0 && !timestamp.isEmpty()) {
                        jobList.add(new JobCollect(name, clientId, duration, deadline, timestamp));
